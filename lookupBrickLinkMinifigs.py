...
try:
	bricklink_category_cache = yaml.safe_load( open( "bricklink_category_cache.yml", "r" ) )
	print("loaded %d entires from bricklink_category_cache"%(len(bricklink_category_cache)))
except IOError:
	bricklink_category_cache = {}

try:
	bricklink_set_cache = yaml.safe_load( open( "bricklink_set_cache.yml", "r" ) )
...
if __name__ == '__main__':
	...
	yaml.dump( bricklink_set_cache, open( "bricklink_set_cache.yml", "w" ) )
